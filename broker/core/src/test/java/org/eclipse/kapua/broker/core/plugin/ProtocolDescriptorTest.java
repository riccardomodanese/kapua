...
import org.eclipse.kapua.consumer.commons.plugin.DefaultProtocolDescriptionProvider;
import org.eclipse.kapua.consumer.commons.plugin.MessageType;
import org.eclipse.kapua.consumer.commons.plugin.ProtocolDescriptor;
import org.eclipse.kapua.consumer.commons.plugin.ProtocolDescriptorProvider;
...
public class ProtocolDescriptorTest {
    ...
    public void testDefault1b() {
        Assert.assertNotNull(ProtocolDescriptorProviders.getDescriptor("foo"));
    }
    ...
    public void testDefault2() {
        ...
        properties.put(ConsumerSettingKey.DISABLE_DEFAULT_PROTOCOL_DESCRIPTOR.key(), "true");
    ...
    public void testDefault3() {
        final Map<String, String> properties = new HashMap<>();
        properties.put(ConsumerSettingKey.CONFIGURATION_URI.key(), "file:src/test/resources/does-not-exist.properties");
    ...
    public void testDefault4() {
        final Map<String, String> properties = new HashMap<>();
        properties.put(ConsumerSettingKey.CONFIGURATION_URI.key(), "file:src/test/resources/conector.descriptor/1.properties");
    ...
    public void testDefault6() throws Exception {
        final Map<String, String> properties = new HashMap<>();
        properties.put(ConsumerSettingKey.DISABLE_DEFAULT_PROTOCOL_DESCRIPTOR.key(), "true");
        properties.put(ConsumerSettingKey.CONFIGURATION_URI.key(), "file:src/test/resources/conector.descriptor/2.properties");
    ...
    public void testDefault7() {
        final Map<String, String> properties = new HashMap<>();
        properties.put(ConsumerSettingKey.DISABLE_DEFAULT_PROTOCOL_DESCRIPTOR.key(), "true");
        properties.put(ConsumerSettingKey.CONFIGURATION_URI.key(), "file:src/test/resources/conector.descriptor/3.properties");
    ...
    public void testConfig1() {
        final Map<String, String> properties = new HashMap<>();
        properties.put(ConsumerSettingKey.CONFIGURATION_URI.key(), "");
